...
public class CuiView {
    ...
    private User logInProcess(Scanner scanner) throws SQLException {
    ...
    private User register(Scanner scanner) throws SQLException {
    ...
    private Dog adoptionProcess(Scanner scanner, User user) throws SQLException {
